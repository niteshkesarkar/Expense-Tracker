 ...
 * @since  0.0.1
 */
class BillsModelGroup extends JModelAdmin
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'Groups', $prefix = 'BillsTable', $config = array())
	{
	...
	public function save($data)
	{
		...
		{
			$membersString = implode(',', $data['members']);
			$data['members'] = $membersString;
		}
