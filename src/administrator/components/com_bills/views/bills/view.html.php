 ...
 * @since  0.0.1
 */
class BillsViewBills extends JViewLegacy
{
/**
	* Display the view
	*
	...
	*/
	...
	{
		JToolBarHelper::title('Bills');
		JToolBarHelper::addNew('bill.add');
		JToolBarHelper::editList('bill.edit');
		JToolBarHelper::deleteList(JText::_('Are you sure to detete this group?'), 'bills.delete', JText::_('Delete'));
	}
}
