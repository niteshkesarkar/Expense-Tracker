 ...
 * @since  0.0.1
 */
class BillsViewTypes extends JViewLegacy
{
/**
	* Display the view
	*
	...
	*/
	...
	{
		JToolBarHelper::title('Types');
		JToolBarHelper::addNew('type.add');
		JToolBarHelper::editList('type.edit');
		JToolBarHelper::deleteList(JText::_('Are you sure to detete this group?'), 'types.delete', JText::_('Delete'));
	}
}
