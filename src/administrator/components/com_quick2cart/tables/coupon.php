 ...
 * @since       2.2
 */
class Quick2cartTableCoupon extends JTable
{
	/**
	 * Constructor
	 *
	...
	public function bind ($array, $ignore = '')
	{
		...
		if (! JFactory::getUser()->authorise('core.admin', 'com_quick2cart.coupon.' . $array['id']))
		{
			$actions = JFactory::getACL()->getActions('com_quick2cart', 'coupon');
			$default_actions = JFactory::getACL()->getAssetRules('com_quick2cart.coupon.' . $array['id'])->getData();
			$array_jaccess = array();
