...
if ($saveOrder)
{
	...
	JHtml::_('sortablelist.sortable', 'attributesetList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<script type="text/javascript">
	...
	Joomla.submitbutton = function(task)
	{
		...
		{
			var confirmdelete = confirm("<?php echo JText::_('COM_QUICK2CART_ATTRIBUTE_SET_DELETE_POPUP');?>");
...
<form action="<?php echo JRoute::_('index.php?option=com_quick2cart&view=attributesets'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
				...
				<table class="table table-striped" id="attributesetList">
					...
					<tr>
						...
						<?php endif; ?>
										...
										<th class='left'>
					<?php echo JHtml::_('grid.sort',  'COM_QUICK2CART_ATTRIBUTESETS_GLOBAL_ATTRIBUTE_SET_NAME', 'a.`global_attribute_set_name`', $listDirn, $listOrder); ?>
					</th>
					...
					<tbody>
						<tr class="row<?php echo $i % 2; ?>">
							...
							<?php if (isset($this->items[0]->state)): ?>
								<td class="center">
									<?php echo JHtml::_('jgrid.published', $item->state, $i, 'attributesets.', $canChange, 'cb'); ?>
								</td>
							<?php endif; ?>
								<td>
									<a href="<?php echo JRoute::_('index.php?option=com_quick2cart&task=attributeset.edit&id='.(int) $item->id); ?>"><?php echo $item->global_attribute_set_name; ?></a>
								</td>
							<?php if (isset($this->items[0]->id)): ?>
			...
			<?php else:?>
				<div class="clearfix"></div>
				<div class="alert alert-no-items"><?php echo JText::_('COM_QUICK2CART_NO_MATCHING_RESULTS');?></div>
			<?php endif;?>
