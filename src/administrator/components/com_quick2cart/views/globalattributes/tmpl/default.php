...
<script type="text/javascript">
	...
	Joomla.submitbutton = function(task)
	{
		...
		{
			var confirmdelete = confirm("<?php echo JText::_('COM_QUICK2CART_ATTRIBUTE_DELETE_POPUP');?>");
...
<form action="<?php echo JRoute::_('index.php?option=com_quick2cart&view=globalattributes'); ?>" method="post" name="adminForm" id="adminForm">
			...
			<table class="table table-striped" id="attributeList">
				...
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_QUICK2CART_GLOBALATTRIBUTES_ATTRIBUTE_NAME', 'a.`attribute_name`', $listDirn, $listOrder); ?>
				</th>
				...
				<tbody>
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $item->state, $i, 'globalattributes.', $canChange, 'cb'); ?>
							</td>
						<?php endif; ?>

										<td>
				<?php if (isset($item->checked_out) && $item->checked_out) : ?>
					<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'globalattributes.', $canCheckin); ?>
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_quick2cart&task=globalattribute.edit&id='.(int) $item->id); ?>">
					<?php echo $this->escape($item->attribute_name); ?></a>
				<?php else : ?>
