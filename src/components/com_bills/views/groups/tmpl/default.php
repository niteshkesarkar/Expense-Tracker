...
<?php
	...
	<?php endif;?>
<form action="<?php echo JRoute::_('index.php?option=com_bills&view=groups'); ?>" method="post" name="adminForm" id="adminForm">
	<div class="row-fluid">
		<div class="span10">
		<?php
		...
		<div class="col-md-10 col-md-offset-2">
			<table class="table table-striped table-hover">
				...
				<tr>
					...
					<th width="50%" class="nowrap center">
				...
				<?php if (!empty($this->items)) : ?>
					...
					$groupLink = JRoute::_('index.php?option=com_bills&task=group.edit&id=' . $row->id);
					?>
						<tr>
							<td class="center">
