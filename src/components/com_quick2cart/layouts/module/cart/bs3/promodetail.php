...
<tr class="active">
	<td colspan="2">
		...
		<div class="input-group modulecartview" id="mod_applyCopWrapper">
			<input type="text" class="form-control qtc_coupon_input_box" id="cart_coupon_code" name="cop" value="" placeholder="<?php echo JText::_('COM_MOD_QUICK2CART_CUPCODE');?>" style="max-width:180px;"></input>
