	...
	function checkForSku(sku)
	{
		...
		if (skuval)
		{
			...
			if (skuval != oldSku)
			{
				...
				var actUrl = "<?php echo $qtc_base_url;?>"+'?option=com_quick2cart&task=attributes.checkSku&sku='+sku+'&tmpl=component';
			...
			<div id='' class=" <?php echo $class_nm;?>" >
				...
				<div class="form-group" style="<?php //echo $StoreIds_style;?>">
					<label for="item_name" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label"><?php echo JHtml::tooltip(JText::_('QTC_PROD_TITLE_DES'), JText::_('QTC_ITEM_NAME'), '', '* ' . JText::_('QTC_ITEM_NAME'));?>
						...
						?>
					<div class="col-sm-8 col-xs-12">
						<input type="text" class=" requiredEE"  name="item_name"  id="item_name" value="<?php echo $comquick2cartHelper->escape($p_title); ?>" />
						...
						{
						?>
						<input type="hidden"   name="store_id" id="store_id" value="<?php echo $default_store_id; ?>" />
						<?php
						}
						*/
						?>
				...
				<div class='form-group' >
					...
					<div class="col-sm-8 col-xs-12">
						<input type="text" class=" requiredEE"  name="sku"  id="sku" onBlur="checkForSku(this.value)" value="<?php echo (!empty($itemDetail['sku'])? $itemDetail['sku'] : ''); ?>" autocomplete='off'  aria-invalid="false"  />
					</div>
				</div>
				<!-- end SKU -->
				...
				<div class="form-group" style="<?php echo $qtc_stock_style;?>">
					...
					<div class="col-sm-8 col-xs-12">
						<input Onkeyup="checkforalpha(this,'45', '<?php echo addslashes($entered_numerics); ?>')"  type="text" name="stock" id="stock" size="32" value="<?php if (isset($minmaxstock->stock)) echo $minmaxstock->stock;?>" class="input-mini validate-integer"  >
					</div>
				</div>
				...
				<div class="form-group" style="<?php echo $qtc_min_max_style;?>">
					...
					<div class="col-sm-8 col-xs-12">
						<input Onkeyup="checkforalpha(this,'', '<?php echo addslashes($entered_numerics); ?>')"  Onchange="checkSlabValue();" type="text" name="item_slab" id="item_slab" size="32" value="<?php echo isset($minmaxstock) ? $minmaxstock->slab: 1  ?>" class="input-mini validate-integer"  >
					</div>
				</div>
				...
				<div class="form-group" style="<?php echo $qtc_min_max_style;?>">
					...
					<div class="col-sm-8 col-xs-12">
						<input
							...
							type="text" name="min_item" id="min_item" value="<?php if (isset($minmaxstock)) echo $minmaxstock->min_quantity;?>" class="input-mini validate-integer"  >
					</div>
				</div>
				<div class="form-group" style="<?php echo $qtc_min_max_style;?>">
					...
					<div class="col-sm-8 col-xs-12">
						<input
						onChange="checkSlabValueField(this,'', '<?php echo addslashes($entered_numerics); ?>')"
						type="text" name="max_item" id="max_item" value="<?php if (isset($minmaxstock))  echo $minmaxstock->max_quantity;?>" class="input-mini validate-integer"  >
					</div>
				</div>
