...
<?php
	...
	<a rel="{handler: 'iframe', size: {x: window.innerWidth-350, y: window.innerHeight-150}, onClose: function(){AddNewMedia(<?php echo $fparam; ?>);}}" class="btn btn-primary btn-small <?php echo ($button_dis == ""?'modal':$button_dis)?> qtcAddMediaLink" href="<?php echo ($button_dis == ""?$addMediaLink:"#")?>" style="display: inline;">
