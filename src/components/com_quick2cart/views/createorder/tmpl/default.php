...
<div class="<?php echo Q2C_WRAPPER_CLASS; ?> container-fluid">
	<form name="createOrder" id="createOrder" class="form-validate form-horizontal" method="post">
		...
		<div class="row">
			<h1 class="col-lg-12"><?php echo JText::_("COM_QUICK2CART_CREATE_ORDER_VIEW_TITLE");?></h1>
		</div>
		<div class="row">
			<div class="col-lg-12 alert alert-info"><?php echo JText::_("COM_QUICK2CART_CREATE_ORDER_VIEW_INFO");?></div>
		</div>
		<div class="row qtc-createorder-buttons">
			<a class="btn btn-primary pull-right qtcMarginLeft col-lg-3" onclick="addClient('<?php echo JUri::root();?>')"><i class="icon-user">&nbsp;</i><?php echo JText::_("COM_QUICK2CART_CREATE_ORDER_ADD_CLIENT");?></a>
			<a class="btn btn-primary pull-right col-lg-3" target="_blank" href="<?php echo JUri::root() . 'index.php?option=com_quick2cart&view=product';?>"><i class=" icon-plus-2 icon22-white22 ">&nbsp;</i><?php echo JText::_("COM_QUICK2CART_POINTS_ADD_PRODUCT_TITLE");?></a>
		</div>
		<div class="clearfix"></div>
		<!-- CODE FOR TABS START-->
			<div>
				...
				<div class="tab-content row">
					...
					<div class="tab-pane active" id="qtctab_selectclient">
						...
						<div class="control-group">
							...
							<div class="controls">
							<?php
								echo JHtml::_('select.genericlist', $this->users, "qtcuser", 'class="ad-status input-medium required" size="1" required onchange="showAddresses();" name="qtcuser"', "id", "username");
							?>
							</div>
						</div>
						<div class="clearfix">&nbsp;</div>
					...
					<div class="tab-pane" id="qtctab_addproduct">
								...
								<div id="qtc_product_div0" class="qtc_product_div">
									<div class="row">
										<div class="col-lg-3">
											...
											<div>
											<?php
												echo JHtml::_('select.genericlist', $this->stores, "qtcorder_productdetails[0][store_id]", 'class="ad-status input-medium required qtcorder_select_chosen" required="required" size="1" onchange="qtcpopulateProducts(\'0\');"', "store_id", "title");
											?>
											</div>
										</div>
										...
										<div id="qtc_remove_Product_button0" class="col-lg-1">
										</div>
										<div class="row">
											<div id="qtc_product_attributes0" class="col-lg-12">
											</div>
										</div>
										<div id="qtc_product_shipping_details_div0" class="hidden row qtc_product_shipping_title_div">
											<h4 class="col-lg-12"><?php echo JText::_("COM_QUICK2CART_CHOOSE_YOUR_DELIVARY_OPTION");?></h4>
										</div>
										<div id="qtc_product_shipping_details0" class="row qtc_product_shipping_method_div">
										</div>
									</div>
								</div>
							</div>
						...
						<div class="clearfix"></div>
						<div class="row">
							<div class="col-lg-12 alert alert-info"><?php echo JText::_("COM_QUICK2CART_CREATE_ORDER_VIEW_ORDER_INFO");?></div>
						</div>
						<div class="qtc-create-order-buttons center">
							<a onclick="qtcaddMoreProduct();" class="btn btn-mini btn-primary" title="Add More"><i class=" icon-plus-2 icon22-white22 "></i><?php echo JText::_('COM_QUICK2CART_CREATE_ORDER_ADD_MORE_PRODUCTS');?>
							</a>
							<a onclick="qtc_place_order();" class="btn btn-mini btn-success"><?php echo JText::_('QTC_CHKOUT');?>
							</a>
						</div>
					</div>
					<!-- tab 2 end -->
