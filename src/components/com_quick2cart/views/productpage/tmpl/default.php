					...
					<div class="<?php echo $prod_divSize;?> qtc_prod_blog_page-bs3">
						...
						<div class="form-horizontal" id="<?php echo $this->item_id;?>_item" style="width: auto;">
							...
							<div class="form-group">
								<label class="col-xs-4 qtc-control-label">
									<strong><?php echo JText::_('QTC_ITEM_AMT')?></strong>
								</label>
								<div class="col-xs-8  qtc_controls_text">
							...
							if ( $discount_present)
							{
								...
								<div class="form-group">
									...
									<div class="col-xs-8 qtc_controls_text" itemprop="offers"
							...
							if ($this->attributes)
							{
								foreach ($this->attributes as $attribute)
								{
									...
									<div class="form-group">
										...
										// Rendor layout
										$layout = new JLayoutFile('productpage.attribute_option_display');
							...
							if (! empty($this->mediaFiles))
							{
								?>
								<div class="form-group">
									<div class="col-xs-4 qtc-control-label">
										<strong><?php echo JText::_( "COM_QUICK2CART_PROD_FREE_DOWNLOAD"); ?></strong>
									</div>
									<div class="col-xs-8 qtc_padding_class_attributes">
										<?php
										$productHelper = new productHelper();
							...
							if ($this->showBuyNowBtn)
							{
								...
								?>
								<div class="form-group" >
									<label class="col-xs-4 qtc-control-label" style="<?php echo $showqty_style; ?>">
