...
<script type="text/javascript">
	...
	function deleteShipProfileMethod(methodId,delBtn)
	{
		...
		techjoomla.jQuery.ajax({
			type : "POST",
			url :"<?php echo JUri::base();?>index.php?option=com_quick2cart&view=shipprofileform&task=shipprofileform.deleteShipProfileMethod&tmpl=component",
			data : data,
    ...
    function qtc_addShipMethod()
    {
		...
		techjoomla.jQuery.ajax({
					type : "POST",
					url :"<?php echo JUri::base();?>index.php?option=com_quick2cart&view=shipprofileform&task=shipprofileform.addShipMethod&tmpl=component",
					data : data,
					dataType: "json",
					beforeSend: function()
					{
