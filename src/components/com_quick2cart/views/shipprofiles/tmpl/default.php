...
-->
			...
			<div class="qtc-btn-group pull-right hidden-xs q2c-btn-wrapper">
				<?php
				echo JHtml::_('select.genericlist', $this->publish_states, "filter_published", 'class=""  onchange="document.adminForm.submit();" name="filter_published"', "value", "text", $this->state->get('filter.state'));
				?>
			</div>
			<div class="qtc-btn-group pull-right hidden-xs q2c-btn-wrapper">
				<?php
				echo JHtml::_('select.genericlist', $this->stores, "filter_store", 'class=""  onchange="document.adminForm.submit();" name="filter_store"', "id", "title", $this->state->get('filter.stores'));
				?>
			</div>
		</div>
