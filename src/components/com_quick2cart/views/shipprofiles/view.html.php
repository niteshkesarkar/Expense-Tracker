...
class Quick2cartViewShipprofiles extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->storeFilters[] = array('id' => 0, 'title' => JText::_('COM_QUICK2CART_COUPONFORM_STORE_SELECT'));
	...
	protected function addTJtoolbar ()
	{
		...
		{
			$tjbar->appendButton('shipprofileform.add', 'TJTOOLBAR_NEW', QTC_ICON_PLUS, 'class="btn btn-small btn-success"');
		}
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			{
				$tjbar->appendButton('shipprofiles.publish', 'TJTOOLBAR_PUBLISH', QTC_ICON_PUBLISH, 'class="btn btn-small btn-success"');
				$tjbar->appendButton('shipprofiles.unpublish', 'TJTOOLBAR_UNPUBLISH', QTC_ICON_UNPUBLISH, 'class="btn btn-small btn-warning"');
			}
		}
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			{
				$tjbar->appendButton('shipprofiles.delete', 'TJTOOLBAR_DELETE', Q2C_ICON_TRASH, 'class="btn btn-small btn-danger"');
			}
		}
