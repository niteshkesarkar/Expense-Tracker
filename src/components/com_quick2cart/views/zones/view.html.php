...
class Quick2cartViewzones extends JViewLegacy
{
	...
	protected function addTJtoolbar ()
	{
		...
		{
			$tjbar->appendButton('zoneform.add', 'TJTOOLBAR_NEW', QTC_ICON_PLUS, 'class="btn btn-small btn-success"');
		}
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			{
				$tjbar->appendButton('zones.publish', 'TJTOOLBAR_PUBLISH', QTC_ICON_PUBLISH, 'class="btn btn-small btn-success"');
				$tjbar->appendButton('zones.unpublish', 'TJTOOLBAR_UNPUBLISH', QTC_ICON_UNPUBLISH, 'class="btn btn-small btn-warning"');
			}
		}
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			{
				$tjbar->appendButton('zones.delete', 'TJTOOLBAR_DELETE', Q2C_ICON_TRASH, 'class="btn btn-small btn-danger"');
			}
		}
