		...
		<table class="table table-condensed ">
			...
			<tbody class="qtc_modulebody">
				...
				if (!empty($cart))
				{
					...
					<tr class="active">
						<td colspan="2">
							<button class="btn btn-danger btn-small btn_margin pull-left span6" onclick="emptycart(<?php echo $msg_order_js . ",'" . $baseUrl."'"; ?>);" >
							...
							<button class="btn btn-primary btn-small btn_margin pull-right span6" onclick="window.open('<?php echo JRoute::_('index.php?option=com_quick2cart&view=cartcheckout&Itemid='.$Itemid);?>','_self')" >
