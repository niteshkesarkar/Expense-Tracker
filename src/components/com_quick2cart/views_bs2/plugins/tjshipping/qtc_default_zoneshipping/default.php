		...
		<?php
			...
			<tr class='row<?php echo $k; ?>'>
				...
				<td>
					...
					?>
					<!--
						[<a class="modal qtc_modal" href="<?php echo JRoute::_($setRateLink); ?>" rel="{handler:'iframe',size:{x: window.innerWidth-80, y: window.innerHeight-80}}" title="<?php  echo JText::_('PLG_QTC_DEFAULT_ZONESHIPPING_CLICK_TO_SETRATE_TITLE'); ?>" >
						<span class="">
