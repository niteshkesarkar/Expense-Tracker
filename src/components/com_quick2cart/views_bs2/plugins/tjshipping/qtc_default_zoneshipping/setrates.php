				...
				<tr>
					...
					<td>
						<div class="input-append curr_margin ">
							<input type="number" name="rangeFrom" size="" id="qtc_shipping_range_start" value="" class=" input-mini " placeholder="<?php echo JText::_("PLG_QTC_DEFAULT_ZONESHIPPING_FROM_HINT"); ?>">
							<?php
						...
						<div class="input-append curr_margin ">
							<input type="number" name="rangeTo" size="" id="qtc_shipping_range_end" value="" class=" input-mini " placeholder="<?php echo JText::_("PLG_QTC_DEFAULT_ZONESHIPPING_TO_HINT"); ?>">
							<?php
							if ($showWeightUnite ==1 )
							{?>
							<span class="add-on "><?php echo $weightUniteSymbol; ?></span>
