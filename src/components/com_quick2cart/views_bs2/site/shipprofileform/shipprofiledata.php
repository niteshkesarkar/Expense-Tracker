...
<script type="text/javascript">
	...
	function deleteShipProfileMethod(methodId,delBtn)
	{
		...
		techjoomla.jQuery.ajax({
			type : "POST",
			url :"<?php echo JUri::base();?>index.php?option=com_quick2cart&view=<?php echo $actionViewName; ?> &task=<?php echo $actionControllerName; ?>.deleteShipProfileMethod&tmpl=component",
			data : data,
	...
	function qtcLoadPlgMethods()
	{
		...
		techjoomla.jQuery.ajax({
				type : "POST",
				url :"<?php echo JUri::base();?>index.php?option=com_quick2cart&view=<?php echo $actionViewName; ?>&task=<?php echo $actionControllerName; ?>.qtcLoadPlgMethods&tmpl=component",
				data : data,
				dataType: "json",
				beforeSend: function()
				{
    ...
    function qtc_addShipMethod()
    {
		...
		techjoomla.jQuery.ajax({
					type : "POST",
					url :"<?php echo JUri::base();?>index.php?option=com_quick2cart&view=<?php echo $actionViewName; ?>&task=<?php echo $actionControllerName; ?>.addShipMethod&tmpl=component",
					data : data,
					dataType: "json",
					beforeSend: function()
					{
