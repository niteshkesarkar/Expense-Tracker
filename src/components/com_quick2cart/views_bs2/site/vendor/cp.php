					...
					<div class="col-sm-12 col-lg-12 col-md-12">
						<div class="pull-right">
							...
							<div class="form-inline">
								...
								<?php echo JHtml::_('calendar', $backdate, 'from', 'from', '%Y-%m-%d', array('class'=>'inputbox input-small form-control', 'readonly'=>'true')); ?>

								<label class="checkbox">
									<?php echo JText::_('QTC_TO_DATE') . "&nbsp;"; ?>
								</label>

								<?php echo JHtml::_('calendar', $currentdate, 'to', 'to', '%Y-%m-%d', array('class'=>'inputbox input-small form-control', 'readonly'=>'true')); ?>
