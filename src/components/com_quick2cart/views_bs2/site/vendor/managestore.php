...
<form  method="post" name="adminForm" id="adminForm" class="form-validate">
	...
	<table class="  table table-striped table-condensed">
		...
		<tr>
			...
			<button type="button" class="btn btn-info  btn_margin" onclick="window.open('<?php echo JRoute::_('index.php?option=com_quick2cart&view=orders&layout=mycustomer');?>','_self')" > <i class="icon-user <?php echo Q2C_ICON_WHITECOLOR; ?>"></i> <?php echo JText::_( 'QTC_MANAGE_STORE_CUSTOMER' ); ?></button>
