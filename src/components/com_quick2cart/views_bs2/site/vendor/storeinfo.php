						...
						<p>
							...
							else
							{
								...
								if ($limit < $description_length)
								{
									// SHOE READ MORE LINK
									?>
									<a title="<?php echo JText::_('QTC_READMORE')?>" class="modal qtc_modal" rel="{handler: 'iframe', size: {x: 720, y: 500}, onClose: function(){}}" class="modal qtc_modal " href="<?php echo $storeinfo_link;?>">
