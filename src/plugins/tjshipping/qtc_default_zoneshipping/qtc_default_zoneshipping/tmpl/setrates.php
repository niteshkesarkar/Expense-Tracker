		...
		<table class=" table table-striped">
			...
			<tbody>
				<tr>
					...
					<td data-title="<?php echo JText::_('PLG_QTC_DEFAULT_ZONESHIPPING_RANGE');?>">
						<div class="input-group curr_margin ">
							<input type="number" name="rangeFrom" size="" id="qtc_shipping_range_start" value="" class=" form-control " placeholder="<?php echo JText::_("PLG_QTC_DEFAULT_ZONESHIPPING_FROM_HINT"); ?>">
							<?php
						...
						<div class="input-group curr_margin ">
							<input type="number" name="rangeTo" size="" id="qtc_shipping_range_end" value="" class=" form-control " placeholder="<?php echo JText::_("PLG_QTC_DEFAULT_ZONESHIPPING_TO_HINT"); ?>">
							<?php
							if ($showWeightUnite ==1 )
							{?>
							<div class="input-group-addon"><?php echo $weightUniteSymbol; ?></div>
				...
				<?php //endif; ?>
					...
					<td class="qtc_ship_rates_validate" data-title="<?php echo JText::_('PLG_QTC_DEFAULT_ZONESHIPPING_SHIP_COST');?>">
						<?php
						// Show shipping cost fields
						echo $productHelper->getMultipleCurrFields($name = 'shipCost');
						?>
					</td>
					<td class="qtc_handle_rates_validate" data-title="<?php echo JText::_('PLG_QTC_DEFAULT_ZONESHIPPING_HANDLE_FEE');?>">
						<?php
						// Show shipping cost fields
